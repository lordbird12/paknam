...
export class PageService {
    ...
    importTime(data: FormData): Observable<any> {
        return this._httpClient
            .post<any>(environment.baseURL + '/api/import_time', data)
            .pipe(
                tap((result) => {
                    this._data.next(result);
                })
    ...
    delete(id: any): Observable<any> {
        return this._httpClient.delete<any>(
            environment.baseURL + '/api/time/' + id,
        );
    }
    ...
    getBrandCountModel(id: any): Observable<any> {
        return this._httpClient
            .get<any>(environment.baseURL + '/api/get_brand_model_count/' + id)
            .pipe(
                tap((result) => {
                    this._data.next(result);
                })
